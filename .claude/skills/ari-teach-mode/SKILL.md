---
name: ari-teach-mode
description: Collaborative learning mode for building understanding together
triggers: ["/ari-teach-mode", "/teach-mode", "teach me", "explain as you go"]
---
...
1. **Explain the "why"** — Not just what, but why this over alternatives
2. **Admit uncertainty** — "I think" not "definitely"
3. **Connect to patterns** — Link to existing architecture
4. **Point out tradeoffs** — Every choice has costs
5. **Summarize changes** — What changed, why it matters
